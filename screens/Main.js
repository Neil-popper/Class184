        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.framesContainer}>
                    ...
                    <TouchableOpacity style={this.state.selected=="regular" ? styles.categoryBoxSelected:style.categoryBox} onPress={()=>this.setState({selected:`regular`})}><Text>Regular</Text></TouchableOpacity>
                    <TouchableOpacity style={this.state.selected=="wayfarer" ? styles.categoryBoxSelected:style.categoryBox} onPress={()=>this.setState({selected:`wayfarer`})}><Text>Wayfarer</Text></TouchableOpacity>
                    <TouchableOpacity style={this.state.selected=="rimless" ? styles.categoryBoxSelected:style.categoryBox} onPress={()=>this.setState({selected:`rimless`})}><Text>rimless</Text></TouchableOpacity>
                    <TouchableOpacity style={this.state.selected=="round" ? styles.categoryBoxSelected:style.categoryBox} onPress={()=>this.setState({selected:`round`})}><Text>round</Text></TouchableOpacity>
                    <TouchableOpacity style={this.state.selected=="aviator" ? styles.categoryBoxSelected:style.categoryBox} onPress={()=>this.setState({selected:`aviator`})}><Text>Aviator</Text></TouchableOpacity>
                    </View>
